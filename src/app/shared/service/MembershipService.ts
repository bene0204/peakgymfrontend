...
export class MembershipService {
  ...
  getMembershipTypes() {
    return this.http.get<MembershiptypeEntity[]>("http://3.68.194.175:8080/public/api/membershiptype/list")
  }

  getRecentMembershipsByOwner(userId: string) {
    return this.http.get<Membership[]>(`http://3.68.194.175:8080/api/membership/recent/${userId}`)
  }

  getAllMembershipsByOwner(userId: string) {
    return this.http.get<Membership[]>(`http://3.68.194.175:8080/api/membership/all/${userId}`)
  }

  saveMembership(body: MembershiptypeEntity) {
    return this.http.post<MembershiptypeEntity>("http://3.68.194.175:8080/admin/api/membershiptype/add", body)
  }

  updateMembership(id: string, body: MembershiptypeEntity) {
    return this.http.patch<MembershiptypeEntity>(`http://3.68.194.175:8080/admin/api/membershiptype/modify/${id}`, body)
  }

  deleteMembership(membershipId: string){
    return this.http.delete(`http://3.68.194.175:8080/admin/api/membershiptype/delete/${membershipId}`)
  }
